          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div>
              ...
              <form className="space-y-gutter" onSubmit={handleSubmit}>
                ...
                <button 
                  className="w-full bg-primary-container hover:bg-primary-container/90 text-white font-display font-bold text-body-md py-4 rounded-xl shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2 mt-6 cursor-pointer disabled:opacity-50 disabled:pointer-events-none" 
                  type="submit"
                  disabled={loading}
                >
